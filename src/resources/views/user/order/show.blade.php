...
<div class="card">
<h5 class="card-header">Chi tiết đơn hàng       <a href="{{route('order.pdf',$order->id)}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> In đơn hàng</a>
  </h5>
  <div class="card-body">
    @if($order)
            ...
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                      ...
                      <td> : @if($order->payment_method=='cod') Trả tiền khi giao hàng @else Chuyển khoản @endif</td>
                    </tr>
                    <tr>
