...
@section('title','Fatoho || Comment Page')
...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary float-left">Danh sách comment tin tức</h6>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      ...
      @else
      <h6 class="text-center">Không có comment nào!!!</h6>
      @endif
    </div>
  </div>
</div>
