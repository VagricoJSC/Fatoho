						...
						<div class="product-des">
							...
							<div class="short">
								...
								<div class="rating-main">
									...
									<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Đã xem</a>
								</div>
								@php
							...
							<div class="product-buy">
								...
								@endif
								<p class="availability">Kho hàng : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span> @endif</p>
							</div>
							<!--/ End Product Buy -->
						</div>
					</div>
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Chi tiết</a></li>
												...
												<div class="ratting-main">
													<div class="avg-ratting">
														{{-- @php 
																		...
																		@endphp --}}
														<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Đánh giá)</span></h4>
						...
						<div class="product-img">
							...
							<div class="button-head">
								<div class="product-action">
									<a data-toggle="modal" data-target="#{{$data->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Mua ngay</span></a>
									<a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Yêu thích</span></a>
									<!--<a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>So sánh giá</span></a>-->
								</div>
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													<div class="quickview-ratting-wrap">
														...
														<a href="#"> ({{$rate_count}} người dùng quan tâm)</a>
													</div>
