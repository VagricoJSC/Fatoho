            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Kiểm Tra Đơn Hàng</a></li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">Daily deal</a></li> --}}
                            @auth
                            @if(Auth::user()->role=='admin')
                            <li><i class="ti-user"></i> <a href="{{route('admin')}}" target="_blank">Admin</a></li>
                            @else
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <!--/ End Search Form -->
                    <div class="sinlge-bar shopping shoping-mobile">
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Từ khóa tìm kiếm....." type="search">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            <div class="shopping-item">
                                <div class="dropdown-cart-header">
                                    ...
                                    <a href="{{route('wishlist')}}">Xem tất cả</a>
                                </div>
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='blog' ? 'active' : ''}}"><a href="{{route('blog')}}">Chính sách bán hàng</a></li>
